...
<section class="help">
    ...
    <div class="help--slides active" data-id="1">
            ...
            <c:forEach items="${institutions}" var="institution">
                <li>
                    ...
                    <div class="col">
                        ...
                        <div >
                            <a class="btn" href="<c:url value="/admin/editinstitution/${institution.id}"/>">EDYTUJ</a>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        ...
                        <div >
                            <a class="btn" href="<c:url value="/admin/deleteinstitution/${institution.id}"/>">USUŃ</a>
                        </div>
                    </div>
        ...
        <p>
            <a class="btn" href="<c:url value="/admin/addinstitution"/>"> DODAJ FUNDACJĘ </a>
        </p>
    </div>
