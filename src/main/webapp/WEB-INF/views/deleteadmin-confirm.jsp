...
<section class="help">
    <h2>Potwierdź usunięcie administratora: ${admin.name} ${admin.surname}</h2>


    <!-- SLIDE 1 -->
    <div class="help--slides active" data-id="1">

        <form action="/admin/deleteadmin-confirm" method="post">
            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
            <input type="hidden" name="id" value="${admin.id}"/>


            <button class="btn" type="submit">USUŃ</button>
            <button class="btn"><a href="<c:url value="/admin/admins"/>">ANULUJ</a></button>
        </form>
