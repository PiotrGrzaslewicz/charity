...
<section class="help">
    ...
    <div class="help--slides active" data-id="1">
            ...
            <c:forEach items="${admins}" var="admin">
                <li>
                    ...
                    <div class="col">
                        ...
                        <div class="subtitle">${admin.name} ${admin.surname}</div>
                    </div>

                    <div class="col">

                        <div >
                            <a class="btn" href="<c:url value="/admin/editadmin/${admin.id}"/>">EDYTUJ</a>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        ...
                        <div >
                            <a class="btn" href="<c:url value="/admin/deleteadmin/${admin.id}"/>">USUŃ</a>
                        </div>
                    </div>
        ...
        <p>
            <a class="btn" href="<c:url value="/admin/addadmin"/>"> DODAJ ADMINISTRATORA </a>
        </p>
    </div>
