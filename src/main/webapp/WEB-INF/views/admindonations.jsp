        ...
        <ul class="help--slides-items">
            ...
            <c:forEach items="${donations}" var="donation">
                <li>
                    ...
                    <div class="col">
                        <div class="title">Nr ${donation.id}</div>
                        <div class="subtitle">Dla: ${donation.institution.name}</div>
                        <div class="subtitle">Ilość worków: ${donation.quantity}</div>
                        <div class="subtitle">Utworzono: ${donation.date}</div>
                        <div class="subtitle">Użytkownik: ${donation.user.name} ${donation.user.surname}</div>
                        <div class="subtitle">Id użytkownika: ${donation.user.id}</div>
                    </div>

                    <div class="col">
                        <div>
                            <a class="btn" href="<c:url value="/user/donationdetails/${donation.id}"/>">Szczegóły</a>
                        </div>
                    </div>

                    <c:if test="${donation.status.status==1}">
                        <div class="col">
                            <div>
                                Odebrano ${donation.status.date}
                            </div>
                        </div>
                    </c:if>
                    ...
                    <div class="col">
                        ...
                        <div>
                            <a class="btn" href="<c:url value="/admin/deletedonation/${donation.id}"/>">USUŃ</a>
                        </div>
                    </div>
