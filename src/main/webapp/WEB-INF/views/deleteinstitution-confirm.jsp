...
<section class="help">
    <h2>Potwierdź usunięcie instytucji: ${institution.name}</h2>


    <!-- SLIDE 1 -->
    <div class="help--slides active" data-id="1">

        <form action="/admin/deleteinstitution-confirm" method="post">
            <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
            <input type="hidden" name="id" value="${institution.id}"/>


                <button class="btn" type="submit">USUŃ</button>
                <button class="btn"><a href="<c:url value="/admin/institutions"/>">ANULUJ</a></button>
        </form>
