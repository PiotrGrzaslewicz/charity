    ...
    <div class="help--slides active" data-id="1">
        ...
        <form action="/admin/addinstitution" method="post">
            ...
            <div class="form-group">
                <input type="text" name="name" placeholder="Nazwa fundacji" required="true"/>
            </div>
            <div class="form-group">
                <textarea name="description" placeholder="Opis fundacji" required="true"></textarea>
            </div>

            <div class="form-group form-group--buttons">

                <button class="btn" type="submit">Utwórz fundację</button>
            </div>
        </form>
